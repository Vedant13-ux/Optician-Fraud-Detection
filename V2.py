...
PEC_classifier Number of reimbursement requests in the ""canceled"" state (%)
...
# Dropping Columns from out Dataframe
df_test = df.drop(["cor_sphere_VG","Prix_verres","facteur_correction","age_moyen","Prix_equipement","Prix_monture", "dep_identique", "taux_non_ventes", "Pourcent_remise_total", "cor_addition_VD"], inplace= False, axis=1)

from statsmodels.stats.outliers_influence import variance_inflation_factor
X_temp = df_test.iloc[:, 1:-1]
